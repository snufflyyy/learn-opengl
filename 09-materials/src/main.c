...
int main() {
    ...
    GLuint object_material_ambient_uniform_location = glGetUniformLocation(object_shader.program, "material.ambient");
    ...
    shader_set_vec3_uniform(object_material_ambient_uniform_location, (vec3) {1.0f, 0.5f, 0.31f});
    shader_set_vec3_uniform(object_material_diffuse_uniform_location, (vec3) {1.0f, 0.5f, 0.31f});
    shader_set_vec3_uniform(object_material_specular_uniform_location, (vec3) {0.5f, 0.5f, 0.5f});
