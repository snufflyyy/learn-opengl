...
int main() {
    ...
    GLuint object_color_uniform_location = glGetUniformLocation(object_shader.program, "object_color");
    GLuint object_light_color_uniform_location = glGetUniformLocation(object_shader.program, "light_color");
    GLuint object_light_position_uniform_location = glGetUniformLocation(object_shader.program, "light_position");
    ...
    shader_set_vec3_uniform(object_color_uniform_location, object_color);
    shader_set_vec3_uniform(object_light_color_uniform_location, light_color);
    shader_set_vec3_uniform(object_light_position_uniform_location, light_position);

    shader_bind(light_shader);
    shader_set_vec3_uniform(light_color_uniform_location, light_color);
